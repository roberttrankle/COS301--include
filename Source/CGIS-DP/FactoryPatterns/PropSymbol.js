...
PropSymbolCreator.prototype.createMap = function(map, vectorSource, wardsSource, symbolSource, colorsPerClass, featureToDisplay, MD, symbolLayer) {
    ...
    var selectedClass = "Well Maintained"; // to be passed as value
