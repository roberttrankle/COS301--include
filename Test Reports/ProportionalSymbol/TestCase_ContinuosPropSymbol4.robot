...
Select Map
    sleep    15s
    wait until element is visible    xpath=//select[@id="mapType_PropSymbol"]
    sleep    3s
...
Select color scheme
    sleep    15s
    wait until element is visible    xpath=//select[@id="cs2"]
    sleep    3s
...
Select classes
    sleep    15s
    wait until element is visible    xpath=//select[@id="cc5"]
    sleep    3s
