...
Open chrome in CORS
    ...
    Go To    file:///C:/Users/Boikanyo/Documents/Academics/3rd%20Year/Semester%202/COS%20301/Assignments/Capstone%20project/CGIS/Demo%203/Pre/23_August_17h00/index.html
    #Enter user details
...
Select attribute variable
    ...
    click element    xpath=//select[@id='attr']//option[text()='ha_dwellin']
    sleep    3s
